...
questions_list = [] 
questions_list.append(Question('как по англиски будет человек', 'human', 'people', 'chelovek', 'minininininini'))
questions_list.append(Question('Кто властелин России', 'Путин', 'Зеденский', 'Парашенко', 'Ургант'))
questions_list.append(Question('Кто такой путин', 'Человек', 'не Человек', 'Хто знает', 'Призедент'))
questions_list.append(Question('Государственный язык в  Монголии', 'Монгольский язык', 'не Монгольский язык', 'Испанский', 'Бразильский'))
questions_list.append(Question('Какого цвета нет на флаге Белоруссии?', 'Зелёный', 'Красный', 'Белый', 'Синий'))
questions_list.append(Question('Что такое Python', 'язык', 'язык програмирования ', '!"!"!"', 'Змейка'))
app = QApplication([])
